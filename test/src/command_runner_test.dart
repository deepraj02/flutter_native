...
void main() {
  group('FlutterNativeCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late FlutterNativeCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = FlutterNativeCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = FlutterNativeCommandRunner();
